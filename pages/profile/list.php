            ...
            <div class="col-lg-12" id="<?php echo $ids['main'] ?>">
                ...
                <div class="card">
                    <div class="card-header" id="followers">
                      <div class="row">
                      <div class="col-sm">
                        <p class="card-title"><em class="fa-solid fa-users"></em> <?php echo $strings['followers'] ?>  : <?php echo FollowersCount($userid) ?></p>
                      </div>
                      </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header" id="followed">
                      <div class="row">
                      <div class="col-sm">
                        <p class="card-title"><em class="fa-solid fa-users"></em> <?php echo $strings['followed'] ?>  : <?php echo FollowedCount($userid) ?></p>
                      </div>
                      </div>
                    </div>
                    <div class="card-body">
